...
from flexie import plotDistWorkspaceTraj, plotWorkspace, plotPathRobot, animateParthRobot
...
button4=tk.Button(frame1, text= 'animate robot following path'  ,command=lambda: animateParthRobot(main_window))
